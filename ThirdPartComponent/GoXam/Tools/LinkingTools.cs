...
namespace Northwoods.GoXam.Tool {
  ...
  public abstract class LinkingBaseTool : DiagramTool {
    ...
    private FrameworkElement FindValidToPort(DependencyObject d) {
    ...
    private FrameworkElement FindValidFromPort(DependencyObject d) {
      FrameworkElement elt = Diagram.FindAncestorOrSelf<FrameworkElement>(d);
      if (elt == null) return null;
      Node node = Diagram.FindAncestor<Node>(elt);
      if (node == null) return null;
    ...
    public virtual bool IsValidLink(Node fromnode, FrameworkElement fromport, Node tonode, FrameworkElement toport) {
      ...
      //?? what if FROMNODE and/or TONODE are null
      Object fromdata = fromnode.Data;
      Object fromid = fromnode.GetPortName(fromport);
      Object todata = tonode.Data;
      Object toid = tonode.GetPortName(toport);
  ...
  /// But it does use temporary nodes and links.
  /// </para>
  /// <para>
  ...
  public class LinkingTool : LinkingBaseTool {
    ...
    protected virtual FrameworkElement FindLinkablePort() {
      ...
      FrameworkElement elt = diagram.Panel.FindElementAt<FrameworkElement>(diagram.FirstMousePointInModel,
    ...
    /// <remarks>
    /// <para>
    /// This calls <see cref="FindLinkablePort"/> and remembers the port as <see cref="StartPort"/>.
    ...
    public override void DoActivate() {
      this.StartPort = FindLinkablePort();
      ...
      if (this.Active) {
        ...
        if (this.TargetPort != null) {
          ...
          if (targetnode != null) {
            ...
            IDiagramModel model = mgr.FindCommonDataModel(fromdata, todata);
      ...
      if (this.Active) {
        ...
        if (this.TargetPort != null) {
          ...
          if (targetnode != null) {
            ...
            IDiagramModel oldmodel = mgr.FindCommonDataModel(oldfromdata, oldtodata);
            IDiagramModel newmodel = mgr.FindCommonDataModel(newfromdata, newtodata);
