...
namespace Northwoods.GoXam.Model {
  ...
  //??? inconsistency in use of optional port parameters, as data, as an predicate arguments

  //?? synchronization! inherit from System.Windows.Threading.DispatcherObject and check access!
  //?? inherit from DependencyObject, and change all properties to be dependency properties

  // support for undo manager
