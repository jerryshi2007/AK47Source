...
namespace Northwoods.GoXam.Model {
  ...
  /// <see cref="GraphLinksModel{NodeType, NodeKey, PortKey, LinkType}.Load"/> methods,
  ...
  ///     &lt;Polygon Fill="Black" Points="8 4  0 8  2 4  0 0" go:LinkPanel.Index="-1" go:LinkPanel.Alignment="1 0.5" go:LinkPanel.Orientation="Along" /&gt;
