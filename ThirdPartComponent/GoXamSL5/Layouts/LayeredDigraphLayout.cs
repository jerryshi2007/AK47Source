              ...
              if (ortho) {
                if (this.Direction == 180 || this.Direction == 0) {
                  ...
                  if (p.Y != next.Y) {
                    ...
                    if (si == 2) {
                      if (this.Direction == 0)
                        mid = Math.Max(mid, prev.X);
                      else
                        mid = Math.Min(mid, prev.X);
                    }
                  ...
                  if (p.X != next.X) {
                    ...
                    if (si == 2) {
                      if (this.Direction == 90)
                        mid = Math.Max(mid, prev.Y);
                      else
                        mid = Math.Min(mid, prev.Y);
                    }
          ...
          if (ortho) {  // do the last zig-zag
            ...
            if (this.Direction == 180 || this.Direction == 0) {
              if (prev.Y != next.Y) {
                double mid;
                if (this.Direction == 0)
                  mid = Math.Min(Math.Max((next.X+prev.X)/2, layerSpaces[vertexTo.Layer]), next.X);
                else
                  mid = Math.Max(Math.Min((next.X+prev.X)/2, layerSpaces[vertexTo.Layer]), next.X);
                pLinkR.InsertPoint(si++, new Point(mid, prev.Y));
                pLinkR.InsertPoint(si++, new Point(mid, next.Y));
              }
            } else {
              if (prev.X != next.X) {
                //Diagram.Debug(((next.Y+prev.Y)/2).ToString() + "  " + layerSpaces[vertexTo.Layer].ToString());
                double mid;
                if (this.Direction == 90)
                  mid = Math.Min(Math.Max((next.Y+prev.Y)/2, layerSpaces[vertexTo.Layer]), next.Y);
                else
                  mid = Math.Max(Math.Min((next.Y+prev.Y)/2, layerSpaces[vertexTo.Layer]), next.Y);
                pLinkR.InsertPoint(si++, new Point(prev.X, mid));
                pLinkR.InsertPoint(si++, new Point(next.X, mid));
              }
            }
