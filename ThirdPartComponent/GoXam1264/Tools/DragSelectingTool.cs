...
namespace Northwoods.GoXam.Tool {
  ...
  public class DragSelectingTool : DiagramTool {
    ...
    static DragSelectingTool() {
      ...
      IncludeProperty = DependencyProperty.Register("Include", typeof(SearchInclusion), typeof(DragSelectingTool), new FrameworkPropertyMetadata(SearchInclusion.Inside));
    }
