<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ObjectHistoryLog.aspx.cs"
	Inherits="PermissionCenter.ObjectHistoryLog" %>
...
<body>
					...
					<ItemTemplate>
						...
						<div>
							<div class="pc-action-tray" id="d" runat="server" visible='<%# this.gridMain.ExportingDeluxeGrid == false %>'>
								<a class="pc-item-cmd" data-id='<%#PermissionCenter.Util.HtmlAttributeEncode(this.id)%>'
	...
	<asp:ObjectDataSource ID="dataSourceMain" runat="server" EnablePaging="False" TypeName="MCS.Library.SOA.DataObjects.Security.DataSources.ObjectHistoryDataSource"
