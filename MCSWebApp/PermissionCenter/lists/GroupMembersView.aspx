<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupMembersView.aspx.cs"
	Inherits="PermissionCenter.GroupMembersView" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" scroll="no" style="overflow: hidden">
<head id="Head1" runat="server">
	<title>权限中心-群组人员预览</title>
...
<body>
				...
				<asp:MultiView ActiveViewIndex="0" runat="server" ID="views">
					<asp:View runat="server">
						<mcs:DeluxeGrid ID="gridMain" runat="server" AutoGenerateColumns="False" DataSourceID="dataSourceMain"
							...
							ShowExportControl="true" GridTitle="预览群组人员" DataKeyNames="ID" CssClass="dataList pc-datagrid"
							TitleCssClass="title" PagerSettings-Position="Bottom" DataSourceMaxRow="0" TitleColor="141, 143, 149"
							TitleFontSize="Large" OnSelectAllCheckBoxClick="toggleMenu" OnSelectCheckBoxClick="toggleMenu">
							<EmptyDataTemplate>
								暂时没有您需要的数据
							</EmptyDataTemplate>
						...
						<mcs:SortItem Text="代码名称" SortExpression="CodeName" />
								...
								<pc:SubRowBoundField DataField="CreateDate" HtmlEncode="true" HeaderText="创建日期" SortExpression="CreateDate"
									...
									<SubRowTemplate>
										...
										<soa:OuNavigator ID="OuNHa0" runat="server" StartLevel="0" TerminalVisible="true"
	...
	<soa:DeluxeObjectDataSource ID="dataSourceMain" runat="server" EnablePaging="True"
		...
		<SelectParameters>
			<asp:QueryStringParameter DbType="String" Name="containerId" QueryStringField="id" />
		</SelectParameters>
