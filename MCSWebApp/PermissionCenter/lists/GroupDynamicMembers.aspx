<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupDynamicMembers.aspx.cs"
    Inherits="PermissionCenter.GroupDynamicMembers" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" scroll="no" style="overflow: hidden">
<head runat="server">
    <title>权限中心-群组条件人员</title>
...
<body>
    ...
    <soa:DataBindingControl runat="server" ID="binding1">
        <ItemBindings>
            <soa:DataBindingItem DataPropertyName="ID" ControlID="hfID" ControlPropertyName="Value"
    ...
    <script type="text/javascript">
        ...
        Sys.Application.add_init(function () {
            ...
            //定制工具啦
            var toolDiv = document.createElement("ul");
