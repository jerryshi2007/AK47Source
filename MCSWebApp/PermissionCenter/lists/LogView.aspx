<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogView.aspx.cs" Inherits="PermissionCenter.LogView" %>
...
<body>
				...
				<Columns>
					...
					<asp:TemplateField HeaderText="操作类别" SortExpression="OperationType">
						<ItemTemplate>
							...
							<pc:LogOperationLabel runat="server" OperationType='<%#Eval("OperationType") %>'></pc:LogOperationLabel>
						</ItemTemplate>
					</asp:TemplateField>
					<asp:TemplateField>
						<HeaderTemplate>
	...
	<soa:DeluxeObjectDataSource ID="dataSourceMain" runat="server" EnablePaging="True"
		TypeName="MCS.Library.SOA.DataObjects.Security.DataSources.SchemaLogDataSource"
