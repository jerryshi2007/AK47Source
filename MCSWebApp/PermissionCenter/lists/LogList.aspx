<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogList.aspx.cs" Inherits="PermissionCenter.LogList" %>
	...
	<div class="pc-frame-container">
		<div class="pc-frame-vs" id="vspanel">
			...
			<div class="pc-frame-right">
				<iframe frameborder="0" id="frmView" style="height: 100%; width:100%" src="about:blank">您的浏览器必须支持IFrame！
				</iframe>
			</div>
