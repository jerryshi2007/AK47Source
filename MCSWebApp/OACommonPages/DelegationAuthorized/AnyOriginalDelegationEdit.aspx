<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnyOriginalDelegationEdit.aspx.cs"
	Inherits="MCS.OA.CommonPages.DelegationAuthorized.AnyOriginalDelegationEdit" %>
					...
					<div id="dcontent">
						<table cellspacing="0" cellpadding="0" style="height: 100%; width: 96%;" border="0">
							<tr>
								...
								<td>
									<HB:OuUserInputControl ID="DelegateSrc" runat="server" MultiSelect="false" Width="200px"
							...
							<tr>
								...
								<td>
									<HB:OuUserInputControl ID="DelegateDest" runat="server" MultiSelect="false" Width="200px"
										SelectMask="User" ListMask="Organization,User" ClassName="inputStyle" />
								</td>
							</tr>
							<tr>
				...
				<td style="height: 80px;" valign="middle">
					<div id="dfooter">
						<p style="vertical-align: middle; height: 40px;">
							<asp:Button AccessKey="S" ID="BtnSave" CssClass="formButton" runat="server" Width="85"
								Text="保存(S)" OnClick="BtnSave_Click" />
