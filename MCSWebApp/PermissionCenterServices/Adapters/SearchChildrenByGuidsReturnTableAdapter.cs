...
{
	public class SearchChildrenByGuidsReturnTableAdapter : QueryChildrenByGuidsAdapterBase<DataTable>
	{
		private string _Keyword;
		private int _MaxCount = 15;

		public SearchChildrenByGuidsReturnTableAdapter(string[] schemaTypes, string[] ids, string keyword, int maxCount, bool recursively, bool includeNonDefault, bool includeDeleted) :
		...
		{
			return SCSnapshotAdapter.Instance.QueryObjectAndRelationByKeywordAndParentIDs(
