...
{
	public class QueryChildrenByCodeNamesReturnTableAdapter : QueryChildrenByCodeNamesAdapterBase<DataTable>
	{
		public QueryChildrenByCodeNamesReturnTableAdapter(string[] schemaTypes, string[] ids, bool recursively, bool includeNonDefault, bool includeDeleted) :
