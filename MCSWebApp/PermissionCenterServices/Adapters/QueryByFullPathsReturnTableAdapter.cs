...
{
	public class QueryByFullPathsReturnTableAdapter : QueryByFullPathsAdapterBase<DataTable>
	{
		public QueryByFullPathsReturnTableAdapter(string[] schemaTypes, string[] ids, bool includeDeleted) :
