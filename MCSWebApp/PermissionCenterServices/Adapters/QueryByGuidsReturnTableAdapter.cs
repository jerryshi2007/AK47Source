...
{
	public class QueryByGuidsReturnTableAdapter : QueryByGuidsAdapterBase<DataTable>
	{
		public QueryByGuidsReturnTableAdapter(string[] schemaTypes, string[] ids, bool includeDeleted) :
