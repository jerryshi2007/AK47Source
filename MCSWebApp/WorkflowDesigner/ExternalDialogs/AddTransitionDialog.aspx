<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTransitionDialog.aspx.cs"
	Inherits="WorkflowDesigner.ExternalDialogs.AddTransitionDialog" %>
			...
			<tr>
				<td class="gridHead">
					<div class="dialogTitle">
						<span class="dialogLogo">增加连线</span>
					</div>
				</td>
			</tr>
			<tr>
				<td style="height: 32px; vertical-align: middle">
					<table style="width: 100%; height: 100%">
						<tr>
							...
							<td>
								<asp:Literal runat="server" ID="targetLiteral"></asp:Literal>
							</td>
						</tr>
					</table>
				</td>
