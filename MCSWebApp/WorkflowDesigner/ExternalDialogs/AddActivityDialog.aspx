<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddActivityDialog.aspx.cs"
	Inherits="WorkflowDesigner.ExternalDialogs.AddActivityDialog" %>
			...
			<tr>
				<td class="gridHead">
					<div class="dialogTitle">
						<span class="dialogLogo">增加活动</span>
					</div>
				</td>
			</tr>
			<tr>
