(function () {
	...
	WFWeb.OpenEditor = {
		...
		Resource: function () {
			...
			var obj = { jsonStr: WFWeb.GetCurrentPropertiesItem.ItemToJson(result),
		...
		CancelReceivers: function () {
			...
			var obj = { jsonStr: strcancelEventReceivers,
				Activities: WFWeb.GlobalProcList.Get(WFWeb.Property.CurrentProcessKey).Activities
			}
			WFWeb.Dialog(url, "", commonFeature, obj, function (result, arg) {
		...
		ProcessStarters: function () {
			...
			var obj = { jsonStr: strProcessStarters,
				Activities: WFWeb.GlobalProcList.Get(WFWeb.Property.CurrentProcessKey).Activities
			}
			WFWeb.Dialog(url, "", commonFeature, obj, function (result, arg) {
		...
		EnterReceivers: function () {
			...
			var obj = { jsonStr: WFWeb.GetCurrentPropertiesItem.GetValueByName("EnterEventReceivers"),
				Activities: WFWeb.GlobalProcList.Get(WFWeb.Property.CurrentProcessKey).Activities
			}
			WFWeb.Dialog(url, "", commonFeature, obj, function (result, arg) {
		...
		LeaveReceivers: function () {
			...
			var obj = { jsonStr: WFWeb.GetCurrentPropertiesItem.GetValueByName("LeaveEventReceivers"),
				Activities: WFWeb.GlobalProcList.Get(WFWeb.Property.CurrentProcessKey).Activities
			}
			WFWeb.Dialog(url, "", commonFeature, obj, function (result, arg) {
	...
	WFWeb.PropertGridOpenEditor = {
		...
		Resources: function (activeEditor) {
			var url = _DeluxeApplicationPath + "/modaldialog/WfResourceEditor.aspx";
			var commonFeature = "dialogWidth:800px; dialogHeight:500px;center:yes;help:no;resizable:yes;scroll:no;status:no";
			var obj = { jsonStr: WFWeb.GetCurrentPropertiesItem.ItemToJson(activeEditor.get_property().value),
				Activities: WFWeb.GlobalProcList.Get(WFWeb.Property.CurrentProcessKey).Activities
			}
			WFWeb.Dialog(url, "", commonFeature, obj, function (result, arg) {
				activeEditor.commitValue(result.jsonStr); ;
		...
		LeaveReceivers: function (activeEditor) {
			...
			WFWeb.Dialog(url, "", commonFeature, obj, function (result, arg) {
				activeEditor.commitValue(result.jsonStr);
				//WFWeb.Property.CurrentObj.LeaveEventReceivers = jQuery.parseJSON(result.jsonStr);
			});
		},
		...
		EnterService: function (activeEditor) {
			...
			WFWeb.Dialog(url, "", commonFeature, obj, function (result, arg) {
				activeEditor.commitValue(result.jsonStr);
				//WFWeb.Property.CurrentObj.EnterEventExecuteServices = jQuery.parseJSON(result.jsonStr);
			});
		},
		LeaveService: function (activeEditor) {
			...
			WFWeb.Dialog(url, "", commonFeature, obj, function (result, arg) {
				activeEditor.commitValue(result.jsonStr);
				// WFWeb.Property.CurrentObj.LeaveEventExecuteServices = jQuery.parseJSON(result.jsonStr);
			});
		}
	};
