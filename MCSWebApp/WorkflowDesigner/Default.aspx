	...
	<table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;">
					...
					<span class="text">流 程 设 计 器</span> <span class="right"><a href="#" class="operationlink"
						onclick="OpenEditor('NewProc');return false;">新建</a> <a href="#" class="operationlink"
							onclick="OpenEditor('Process');return false;">打开</a> <a href="#" id="linkSaveCurrent"
								runat="server" class="operationlink" onclick="document.getElementById('btnSaveCurrent').click();">
								保存当前</a> <a href="#" id="linkSaveAs" runat="server" class="operationlink" onclick="document.getElementById('btnSaveAs').click();">
									另存为</a> <a href="#" id="linkSave" runat="server" class="operationlink" onclick="document.getElementById('btnSave').click();">
										保存全部</a> <a href="#" class="operationlink" onclick="OpenEditor('GlobalParam');return false;">
											全局设置</a> <a href="#" id="linkTemplate" runat="server" class="operationlink" onclick="document.getElementById('btnTemplate').click();">
												删除模板</a> <a href="#" class="operationlink" onclick="OpenEditor('WfMatrixDef');return false;">
													权限矩阵</a> <a href="Introduction/IntroductionIndex.aspx" class="operationlink" target="_blank"
		...
		<tr id="trSLP">
			...
			<td id="rightContent" style="vertical-align: top; width: 20%;">
				<table id="tbPropertyGrid" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;
					padding-top: 3px; font-weight: bold; text-align: left; color: White; font-size: 14;">
					<tr>
						<td>
