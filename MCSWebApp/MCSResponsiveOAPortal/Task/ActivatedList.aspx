<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivatedList.aspx.cs"
    Inherits="MCSResponsiveOAPortal.ActivatedList" %>
        ...
        <div id="main" class="main-content cutover-visibility main-width">
            <div class="panel panel-default ">
                ...
                <div>
                    ...
                    <div id="divSearch" class="well" runat="server" visible="false">
                    ...
                    <res:DeluxeGrid runat="server" ID="gridMain" DataSourceID="dsMain" ShowCheckBoxes="true"
                        ...
                        PageCodeShowMode="Auto" AutoGenerateColumns="False" EnablePersistedSelection="true"
