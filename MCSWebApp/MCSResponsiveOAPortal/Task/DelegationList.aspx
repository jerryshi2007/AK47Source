<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DelegationList.aspx.cs"
    Inherits="MCSResponsiveOAPortal.DelegationList" %>
            ...
            <div class="panel panel-default full-height">
                ...
                <div class="">
                    ...
                    <div class="full-height" style="position: relative; min-height: 500px;">
                        <iframe src="../../OACommonPages/DelegationAuthorized/OriginalDelegationEntry.htm"
                            class="" style="width: 100%; height: 100%; position: absolute; border: 0"></iframe>
                    </div>
                    </form>
                </div>
            </div>
