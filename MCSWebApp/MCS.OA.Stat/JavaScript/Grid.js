...
function popupForm(url, sFeatures)
{
	if (!sFeatures) {
		...
		sFeatures = "width=" + width + ",height=" + height + ",left=" + left + ",top=" + top + ",status=no,resizable=yes,toolbar=no,menubar=no,location=no,scrollbars=yes";
	}
...
{
    var url = '/SinoOceanWebApp/ViewProcess/AppTraceProcessTree.aspx?resourceID={0}';
    popupForm(url);
}
