    ...
    if (src.nodeType === 1 && src.nodeName.toUpperCase() == "BUTTON") {
        ...
        if (typeof (id) == "string" && id.length > 0) {
            if (actionRole === 'delete') {
                ...
                $pc.showDialog("/MCSWebApp/PermissionCenter/lists/AppRoleMembersView.aspx?role=" + encodeURIComponent(id), null, null, false, 800, 600, true);
            }
...
function addRoleClick() {
    ...
    if (grid) {
        ...
        if ($pc.showDialog("RoleSearchDialog.aspx", { window: window, inputElem: "actionData" }, null, false, 800, 600, true) == true) {
