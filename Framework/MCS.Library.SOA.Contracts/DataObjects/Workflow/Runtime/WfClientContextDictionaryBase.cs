...
namespace MCS.Library.SOA.Contracts.DataObjects.Workflow
{
    ...
    #region
    //public abstract class WfClientContextDictionaryBase<TKey, TValue> : IEnumerable
    //{
    ...
    [Serializable]
    public class WfClientActivityContext:Dictionary<string,object>
    {
    ...
    [CollectionDataContract(IsReference = true)]
    [Serializable]
    public class WfClientProcessContext : Dictionary<string,object>
    {
    }
}
