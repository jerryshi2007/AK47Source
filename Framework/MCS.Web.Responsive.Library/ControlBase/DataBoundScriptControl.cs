...
namespace MCS.Web.Responsive.Library.Script
{
    ...
    public class DataBoundScriptControl : ScriptControlBase
    {
        ...
        public DataBoundScriptControl(HtmlTextWriterTag tag)
            : base(tag)
        {            
        }
        ...
        /// Initializes a new DataBoundScriptControl
        /// </summary>
        protected DataBoundScriptControl()
            : base()
        {
        }
        ...
        /// </summary>
		/// <param name="tag">控件的TagKey</param>
        protected DataBoundScriptControl(string tag)
            : base(tag)
        {
        }
        ...
        protected DataBoundScriptControl(bool enableClientState)
        ...
        protected DataBoundScriptControl(bool enableClientState, HtmlTextWriterTag tag)
		...
		/// <param name="tag">控件的TagKey</param>
        protected DataBoundScriptControl(bool enableClientState, string tag)
            : base(enableClientState, tag)
        {
        }
        #endregion
