    ...
    applyProperties: function (target, properties) {
        ...
        for (var p in properties) {
            if (p == "__type")
                continue;
            if (p === "innerText") {
                this.innerText(target, properties[p]);
                continue;
            }
            var pv = properties[p];
    ...
    tryFireEvent: function (element, eventName, properties) {
        ...
        try {
            if (document.createEventObject) {
                ...
                if (def) {
                    e = document.createEvent(def.eventGroup);
...
$HGRootNS.TimeSpan.parse = function (text) {
    ...
    var parts = text.split(":"), parts2, d = 0, h = 0, m = 0, s = 0, n = 0, ticks = 0;
