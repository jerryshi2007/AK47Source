...
[assembly: WebResource("MCS.Web.Responsive.WebControls.ClientGrid.ClientGrid.js", "application/x-javascript")]
[assembly: WebResource("MCS.Web.Responsive.WebControls.ClientGrid.ClientGrid.css", "text/css")]
...
namespace MCS.Web.Responsive.WebControls
{
    ...
    [ClientScriptResource("MCS.Web.WebControls.ClientGrid", "MCS.Web.Responsive.WebControls.ClientGrid.ClientGrid.js")]
    [ClientCssResource("MCS.Web.Responsive.WebControls.ClientGrid.ClientGrid.css")]
    [ToolboxData("<{0}:ClientGrid runat=\"server\"><Columns></Columns></{0}:ClientGrid>")]
    public class ClientGrid : ScriptControlBase
    {
        ...
        private void InitTemplateControls()
        {
            ...
            div.Attributes["class"] = "client-grid-templates";
            div.Style[HtmlTextWriterStyle.Display] = "none";

            div.Controls.Add(picker);
        ...
        public new bool ReadOnly
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "OverrideReadOnly", false);
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "OverrideReadOnly", value);
            }
        }
        ...
        public bool AutoBindOnLoad
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "autoBindOnLoad", true);
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "autoBindOnLoad", value);
            }
        }
        ...
        public int RenderBatchSize
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "renderBatchSize", 20);
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "renderBatchSize", value);
            }
        }
        ...
        public bool ShowEditBar
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "showEditBar", false);
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "showEditBar", value);
            }
        }
        ...
        public bool ShowFooter
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "showFooter", false);
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "showFooter", value);
            }
        }
        ...
        public bool ShowCheckBoxColumn
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "ShowCheckBoxColumn", true);
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "ShowCheckBoxColumn", value);
            }
        }
        ...
        public bool SelectedByDefault
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "selectedByDefault", false);
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "selectedByDefault", value);
            }
        }
        ...
        public int PageSize
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "PageSize", 1024000);
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "PageSize", value);
            }
        }
        ...
        public string Caption
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "Caption", string.Empty);
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "Caption", value);
            }
        }
        ...
        public string EmptyDataText
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "EmptyDataText", Translator.Translate(Define.DefaultCulture, "没有记录"));
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "EmptyDataText", value);
            }
        }
        ...
        public string EmptyDataHTML
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "EmptyDataHTML", Translator.Translate(Define.DefaultCulture, ""));
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "EmptyDataHTML", value);
            }
        }
        ...
        public bool AllowPaging
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "AllowPaging", false);
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "AllowPaging", value);
            }
        }
        ...
        public bool AutoPaging
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "AutoPaging", false);
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "AutoPaging", value);
            }
        }
        ...
        //    get
        //    {
        //        return ViewStateExtension.GetViewStateValue(ViewState, "CellPadding", "0px");
        //    }
        //    set
        //    {
        //        ViewStateExtension.SetViewStateValue(ViewState, "CellPadding", value);
        //    }
        //}
        ...
        //    get
        //    {
        //        return ViewStateExtension.GetViewStateValue(ViewState, "CellSpacing", "0px");
        //    }
        //    set
        //    {
        //        ViewStateExtension.SetViewStateValue(ViewState, "CellSpacing", value);
        //    }
        //}
        ...
        //        return ViewStateExtension.GetViewStateValue(ViewState, "CssClass", "clientGrid");
        //    }
        //    set
        //    {
        //        ViewStateExtension.SetViewStateValue(ViewState, "CssClass", value);
        //    }
        //}
        ...
        //    get
        //    {
        //        return ViewStateExtension.GetViewStateValue(ViewState, "HoveringItemCssClass", "hoveringItem");
        //    }
        //    set
        //    {
        //        ViewStateExtension.SetViewStateValue(ViewState, "HoveringItemCssClass", value);
        //    }
        //}
        ...
        public string SelectedItemCssClass
        {
            get
            {
                return ViewStateExtension.GetViewStateValue(ViewState, "SelectedItemCssClass", "selectedItem");
            }
            set
            {
                ViewStateExtension.SetViewStateValue(ViewState, "SelectedItemCssClass", value);
            }
        }

        [ScriptControlProperty]
        [ClientPropertyName("toolbarRowCssClass")]
        [DefaultValue("")]
        [Description("工具行的CSS样式")]
        [Category("Appearance")]
        [CssClassProperty]
        public string ToolbarRowCssClass
        {
            get { return ViewStateExtension.GetViewStateValue(ViewState, "ToolbarRowCssClass", string.Empty); }
            set { ViewStateExtension.SetViewStateValue(ViewState, "ToolbarRowCssClass", value); }
        }

        [ScriptControlProperty]
        [ClientPropertyName("toolbarButtonCssClass")]
        [DefaultValue("btn btn-link")]
        [Description("工具行的CSS样式")]
        [Category("Appearance")]
        [CssClassProperty]
        public string ToolbarButtonCssClass
        {
            get { return ViewStateExtension.GetViewStateValue(ViewState, "ToolbarButtonCssClass", "btn btn-link"); }
            set { ViewStateExtension.SetViewStateValue(ViewState, "ToolbarButtonCssClass", value); }
        }
        ...
        [DefaultValue("")]
        [ScriptControlEvent]
        [ClientPropertyName("editBarRowCreated")]
        [Bindable(true), Category("ClientEventsHandler"), Description("editBarRow创建后事件")]
        public string OnEditBarRowCreated
        {
            get
            {
                return GetPropertyValue("OnEditBarRowCreated", string.Empty);
            }
            set
            {
                SetPropertyValue("OnEditBarRowCreated", value);
            }
        }
        ...
        [DefaultValue(0)]
        private int TotalWidthOfFixeLines
        {
            //移动列的总宽度
            get;
            set;
        ...
        [DefaultValue(0)]
        private int TotalWidthOfNotFixeLines
        {
            //移动列的总宽度
            get;
            set;
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            for (int i = 0; i < this.Columns.Count; i++)
            {
                ...
                if (string.IsNullOrEmpty(this.Columns[i].EditTemplate.TemplateControlID) == false)
                {
            ...
            this.SettleTotalWidthOfNotFixeLines();
        }
        ...
        private bool SettleOuUserInput()
        {
            ...
            for (int i = 0; i < this.Columns.Count; i++)
            {
                ...
                {
                    if (string.IsNullOrEmpty(column.EditTemplate.TemplateControlID) && string.IsNullOrEmpty(column.EditTemplate.TemplateControlClientID))
                    {
                        result = true;
        ...
        /// 获取非固定列的总宽度
        /// </summary>
        private void SettleTotalWidthOfNotFixeLines()
        {
            foreach (var item in this.Columns)
            {
                if (item.Visible)
                {
                    ...
                    if (!item.IsFixedLine)
                        this.TotalWidthOfNotFixeLines += int.Parse(temp);
                    else
                        this.TotalWidthOfFixeLines += int.Parse(temp);
