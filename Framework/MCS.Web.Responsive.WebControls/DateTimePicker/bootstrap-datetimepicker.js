...
;(function ($) {
    ...
    var dpgId = 0,
        emptyDate = new Date(-62135596800000),
        isEmptyDate = function(date){
            return date * 1 == emptyDate * 1;
        },
        ...
        DateTimePicker = function (element, options) {
            var defaults = {
                ...
                init = function () {
                    ...
                    if (!picker.format) {
                        ...
                        else picker.format = picker.element.find('input.input-field').data('format');
                        if (!picker.format) {
                ...
                notifyBeforeParse = function(strValue){
                ...
                update = function (newDate) {
                    ...
                    if (!dateStr) {
                        if (picker.isInput) {
                            ...
                            dateStr = picker.element.find('input.input-field').val();
                        }
                ...
                fillDate = function () {
                    ...
                    while (prevMonth.isBefore(nextMonth)) {
                        ...
                        if (picker.options.todayDate) {
                            if(prevMonth.year()==picker.options.todayDate.getFullYear() && prevMonth.month() == picker.options.todayDate.getMonth() && prevMonth.date() == picker.options.todayDate.getDate()){
                                clsName += " hint";
                            }
                        }
                ...
                change = function (e) {
                    ...
                    var input = $(e.target);
                    notifyBeforeParse(input.val());

                    var val = moment(input.val()), oldDate = picker.date;
                ...
                set = function() {
                    ...
                    if (!picker.isInput) {
                        if (picker.component) {
                            input = picker.element.find('input.input-field');
                            input.val(formatted);
                        }
            ...
            picker.show = function (e) {
                ...
                picker.disable = function () {
                    picker.element.find('input.input-field').prop('disabled', true);
                    detachDatePickerEvents();
                },

                picker.enable = function () {
                    picker.element.find('input.input-field').prop('disabled', false);
                    attachDatePickerEvents();
                },
