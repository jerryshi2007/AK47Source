...
namespace MCS.Library.Passport
{
	...
	public class Ticket : ITicket
	{
		...
		public void SaveToCookie()
		{
			...
			HttpCookie cookie = new HttpCookie(PassportClientSettings.GetConfig().TicketCookieKey, Common.EncryptString(strData));
		...
		public bool IsValid()
		{
			...
			try
			{
				...
				ExceptionHelper.TrueThrow<AuthenticateException>(IsDifferentAthenticateServer(), Resource.DifferentAthenticateServer);
