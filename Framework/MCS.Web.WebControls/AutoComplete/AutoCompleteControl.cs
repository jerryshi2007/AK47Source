...
namespace MCS.Web.WebControls
{
	...
	[ClientScriptResource("MCS.Web.WebControls.AutoCompleteControl", "MCS.Web.WebControls.AutoComplete.AutoCompleteExtender.js")]
			...
			get
			{
				if (this._targetControl == null)
				{
					if (string.IsNullOrEmpty(this.TargetControlID) == false)
						this._targetControl = WebControlUtility.FindControlByID(WebUtility.GetCurrentPage(), this.TargetControlID, true);
				}
