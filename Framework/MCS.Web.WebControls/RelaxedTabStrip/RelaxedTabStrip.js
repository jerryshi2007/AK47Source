...
//Type.registerNamespace("MCS.Web.WebControls.RelaxedTabStrip");

$HGRootNS.RelaxedTabStripActiveEventArgs = function (index, id, tag) {
    //用于激活事件的参数
...
$HGRootNS.RelaxedTabStripActiveEventArgs.prototype = {
    get_index: function () {
        return this._index;
...
$HGRootNS.RelaxedTabStripActiveEventArgs.registerClass($HGRootNSName + '.RelaxedTabStripActiveEventArgs', Sys.EventArgs);

$HGRootNS.RelaxedTabPage = function (owner, headerElement, bodyElement) {
...
$HGRootNS.RelaxedTabPage.prototype = {
    get_owner: function () {
        return this._owner;
    }, get_header: function () {
        return this._header;
...
$HGRootNS.RelaxedTabStrip = function (element) {
    $HGRootNS.RelaxedTabStrip.initializeBase(this, [element]);
...
$HGRootNS.RelaxedTabStrip.prototype = {
    initialize: function () {
        this._isInitDone = false;
        inst = this;
        $HGRootNS.RelaxedTabStrip.callBaseMethod(this, 'initialize');
        ...
        if (headers.length == bodies.length) {
            ...
            for (var i = 0; i < len; i++) {
                this._tabPages.push(new $HGRootNS.RelaxedTabPage(this, headers[i], bodies[i]));
            }
    ...
    dispose: function () {
        ...
        $HGRootNS.RelaxedTabStrip.callBaseMethod(this, 'dispose');
    ...
    _moveToTab: function (tab) {
        ...
        } else if (tab instanceof $HGRootNS.RelaxedTabPage) {
...
$HGRootNS.RelaxedTabStrip.descriptor = {
    properties: [{ name: 'active', type: String}]
}

$HGRootNS.RelaxedTabStrip.registerClass($HGRootNSName + '.RelaxedTabStrip', Sys.UI.Control);
