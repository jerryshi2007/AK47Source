...
GridColumnSorter
*/
$HGRootNS.GridColumnSorter = function (element) {
    $HGRootNS.GridColumnSorter.initializeBase(this, [element]);
    this.sortItems = null;
}

$HGRootNS.GridColumnSorter.prototype = {
    initialize: function () {
        $HGRootNS.GridColumnSorter.callBaseMethod(this, 'initialize');
    ...
    dispose: function () {
        ...
        this.sortItems = null;
        $HGRootNS.GridColumnSorter.callBaseMethod(this, 'dispose');
    },
...
$HGRootNS.GridColumnSorter.registerClass($HGRootNSName + ".GridColumnSorter",  $HGRootNS.ControlBase);
