CREATE TABLE [WF].[MATRIX_DIMENSION_DEFINITION] (
    ...
    CONSTRAINT [PK_MATRIX_DIMENSION_DEFINITION] PRIMARY KEY CLUSTERED ([MATRIX_DEF_KEY] ASC, [DIMENSION_KEY] ASC, [TENANT_CODE] ASC)
);

GO

CREATE INDEX [IX_MATRIX_DIMENSION_DEFINITION_TENANT_CODE] ON [WF].[MATRIX_DIMENSION_DEFINITION] ([TENANT_CODE])
