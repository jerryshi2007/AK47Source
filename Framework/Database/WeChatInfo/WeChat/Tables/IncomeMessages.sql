CREATE TABLE [WeChat].[IncomeMessages]
(
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'WeChat',
    @level1type = N'TABLE',
    @level1name = N'IncomeMessages',
    @level2type = N'COLUMN',
    @level2name = N'MessageID'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'微信公众号（机器人）接收到的原始消息',
    @level0type = N'SCHEMA',
    @level0name = N'WeChat',
    @level1type = N'TABLE',
    @level1name = N'IncomeMessages',
...
CREATE INDEX [IX_IncomeMessages_SentTime] ON [WeChat].[IncomeMessages] ([SentTime])
