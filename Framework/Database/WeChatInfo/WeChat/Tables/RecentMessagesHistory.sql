CREATE TABLE [WeChat].[RecentMessagesHistory]
(
    ...
    CONSTRAINT [PK_RecentMessagesHistory] PRIMARY KEY ([AccountID], [MessageID])
)

GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'微信公众平台中某公众号的历史消息',
    @level0type = N'SCHEMA',
    @level0name = N'WeChat',
    @level1type = N'TABLE',
    @level1name = N'RecentMessagesHistory',
    @level2type = NULL,
    @level2name = NULL
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
...
CREATE INDEX [IX_RecentMessagesHistory_MessageID] ON [WeChat].[RecentMessagesHistory] ([MessageID])

GO

CREATE INDEX [IX_RecentMessagesHistory_SentTime] ON [WeChat].[RecentMessagesHistory] ([SentTime])
