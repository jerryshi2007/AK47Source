// MCS.Library.HtmlParser V1.0 - Simon Mourier <simonm@microsoft.com>
using System;
...
namespace MCS.Library.HtmlParser
{
    ...
    public class HtmlNodeNavigator : XPathNavigator
    {
        ...
        internal void InternalTrace(object traceValue)
        {
            ...
            MCS.Library.HtmlParser.Trace.WriteLine(string.Format("oid={0},n={1},a={2},v={3},{4}", GetHashCode(), nodename, _attindex, nodevalue, traceValue), "N!" + name);
        }
