...
namespace MCS.Library.SOA.DataObjects
{
    ...
    public class UserTaskCollection : EditableDataObjectCollectionBase<UserTask>
    {
        ...
        /// <summary>
        /// 复制TaskID不重复的UserTask
        /// </summary>
        /// <param name="source"></param>
        public void CopyFromNotExistedTaskID(IEnumerable<UserTask> source)
        {
            this.CopyFrom(source, (st) => this.Exists(t => string.Compare(t.TaskID, st.TaskID, true) == 0) == false);
        }
        ...
        /// <summary>
        /// 删除在sourceTasks中的UserTask
        /// </summary>
        /// <param name="source"></param>
        public void RemoveExistedTasks(IEnumerable<UserTask> source)
        {
            this.Remove(t => source.Exists(st => string.Compare(st.TaskID, t.TaskID, true) == 0));
        }
