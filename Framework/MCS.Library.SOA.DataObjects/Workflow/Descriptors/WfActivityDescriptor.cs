...
namespace MCS.Library.SOA.DataObjects.Workflow
{
    ...
    public partial class WfActivityDescriptor : WfKeyedDescriptorBase, IWfActivityDescriptor, ISimpleXmlSerializer
    {
        ...
        private WfServiceOperationDefinitionCollection _WithdrawExecuteServices;

        private WfServiceOperationDefinitionCollection _BeWithdrawnExecuteServices;
        ...
        /// </summary>
        public string EnterEventExecuteServiceKeys
        {
            get
            {
                return this.Properties.GetValue("EnterEventExecuteServiceKeys", string.Empty);
            }
            set
            {
                this.Properties.SetValue("EnterEventExecuteServiceKeys", value);
            }
        }
        ...
        /// </summary>
        public string LeaveEventExecuteServiceKeys
        {
            get
            {
                return this.Properties.GetValue("LeaveEventExecuteServiceKeys", string.Empty);
            }
            set
            {
                this.Properties.SetValue("LeaveEventExecuteServiceKeys", value);
            }
        }
        ...
        /// 撤回到此活动时调用的Service
        /// </summary>
        public WfServiceOperationDefinitionCollection WithdrawExecuteServices
        {
            get
            {
                if (this._WithdrawExecuteServices == null)
                {
                    this._WithdrawExecuteServices = new WfServiceOperationDefinitionCollection();
                }

                return this._WithdrawExecuteServices;
            }
        }
        ...
        /// 被撤回活动调用的Service
        /// </summary>
        public WfServiceOperationDefinitionCollection BeWithdrawnExecuteServices
        {
            get
            {
                if (this._BeWithdrawnExecuteServices == null)
                {
                    this._BeWithdrawnExecuteServices = new WfServiceOperationDefinitionCollection();
                }

                return this._BeWithdrawnExecuteServices;
            }
        }
        ...
        /// 被撤回执行服务的Key
        /// </summary>
        public string BeWithdrawnExecuteServiceKeys
        {
            get
            {
                return this.Properties.GetValue("BeWithdrawnExecuteServiceKeys", string.Empty);
            }
            set
            {
                this.Properties.SetValue("BeWithdrawnExecuteServiceKeys", value);
            }
        }
        ...
        /// 撤回执行服务的Key
        /// </summary>
        public string WithdrawExecuteServiceKeys
        {
            get
            {
                return this.Properties.GetValue("WithdrawExecuteServiceKeys", string.Empty);
            }
            set
            {
                this.Properties.SetValue("WithdrawExecuteServiceKeys", value);
            }
        }
        ...
        public override void SyncPropertiesToFields()
        {
            ...
            this.WithdrawExecuteServices.SyncPropertiesToFields(this.Properties["WithdrawExecuteServices"]);
            this.BeWithdrawnExecuteServices.SyncPropertiesToFields(this.Properties["BeWithdrawnExecuteServices"]);
        ...
        private void CloneCollectionProperties(WfActivityDescriptor targetActDesp)
        {
            ...
            targetActDesp.WithdrawExecuteServices.Clear();
            targetActDesp.WithdrawExecuteServices.CopyFrom(this.WithdrawExecuteServices, s => s.Clone());

            targetActDesp.BeWithdrawnExecuteServices.Clear();
            targetActDesp.BeWithdrawnExecuteServices.CopyFrom(this.BeWithdrawnExecuteServices, s => s.Clone());
        }
        ...
        void ISimpleXmlSerializer.ToXElement(XElement element, string refNodeName)
        {
            ...
            if (this.WithdrawExecuteServices.Count > 0)
                ((ISimpleXmlSerializer)this.WithdrawExecuteServices).ToXElement(element, "WithdrawExecuteServices");

            if (this.BeWithdrawnExecuteServices.Count > 0)
                ((ISimpleXmlSerializer)this.BeWithdrawnExecuteServices).ToXElement(element, "BeWithdrawnExecuteServices");
