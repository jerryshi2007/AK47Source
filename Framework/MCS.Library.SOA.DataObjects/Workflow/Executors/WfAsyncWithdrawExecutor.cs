...
namespace MCS.Library.SOA.DataObjects.Workflow
{
	...
	/// 异步撤回流程
	/// </summary>
	public class WfAsyncWithdrawExecutor : WfExecutorBase
	{
		public WfAsyncWithdrawExecutor(IWfActivity operatorActivity, IWfProcess process)
			: base(operatorActivity, WfControlOperationType.AsyncWithdraw)
		{
		...
		{
			(this.Process.Status == WfProcessStatus.Running).FalseThrow("流程不在运行中，无法撤回");
