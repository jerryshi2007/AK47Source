...
namespace MCS.Web.Library.Script.Mechanism
{
    internal class JavaScriptObjectDeserializer
    {
        ...
        private void ThrowIfMaxJsonDeserializerMembersExceeded(int count)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(AtlasWeb.CollectionCountExceeded_JavaScriptObjectDeserializer,
                    new object[] { AppSettings.MaxJsonDeserializerMembers }));
            }
        }
    }
}
