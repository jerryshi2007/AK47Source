...
namespace MCS.Library.SOA.DataObjects.Security.Converters
{
	public class SchemaObjectSimpleConverter : JavaScriptConverter
	{
		...
		public override IEnumerable<Type> SupportedTypes
		{
			get 
			{
				return new Type[] { typeof(SchemaObjectBase), typeof(SCOrganization), typeof(SCUser), typeof(SCGroup) };
			}
		}
	}
}
