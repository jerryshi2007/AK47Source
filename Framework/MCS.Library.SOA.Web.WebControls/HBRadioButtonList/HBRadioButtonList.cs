...
namespace MCS.Web.WebControls
{
	public class HBRadioButtonList : RadioButtonList
	{
		...
		public string OnClientValueChanged
		{
			get
			{
				return WebControlUtility.GetViewStateValue<string>(ViewState, "OnClientValueChanged", "");
			}
			set
			{
				WebControlUtility.SetViewStateValue<string>(ViewState, "OnClientValueChanged", value);
			}
		}
		...
		protected override void OnPreRender(EventArgs e)
		{
			string script = ResourceHelper.LoadStringFromResource(Assembly.GetExecutingAssembly(),
																  "MCS.Web.WebControls.HBRadioButtonList.HBRadioButtonList.js");
