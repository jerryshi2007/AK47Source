$HBRootNS.WfExtActivityDescriptorEditor = function (element) {
	$HBRootNS.WfExtActivityDescriptorEditor.initializeBase(this, [element]);
...
$HBRootNS.WfExtActivityDescriptorEditor.prototype =
{
	initialize: function () {
		this._initialize();
		$HBRootNS.WfExtActivityDescriptorEditor.callBaseMethod(this, 'initialize');

		this._userInputControl = $find(this.get_userInputClientID());
	},

	dispose: function () {
		$HBRootNS.WfExtActivityDescriptorEditor.callBaseMethod(this, 'dispose');
	},
	...
	get_activityDescriptorInfo: function () {
		...
		result.users = this._userInputControl.get_consignUsers();
		result.circulateUsers = this._userInputControl.get_circulators();
...
$HBRootNS.WfExtActivityDescriptorEditor.registerClass($HBRootNSName + ".WfExtActivityDescriptorEditor", $HBRootNS.DialogControlBase);