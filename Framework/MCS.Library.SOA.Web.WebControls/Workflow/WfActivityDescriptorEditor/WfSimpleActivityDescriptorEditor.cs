...
[assembly: WebResource("MCS.Web.WebControls.Workflow.WfActivityDescriptorEditor.WfSimpleActivityDescriptorEditor.js", "application/x-javascript")]

namespace MCS.Web.WebControls
{
	[RequiredScript(typeof(ControlBaseScript), 1)]
	[RequiredScript(typeof(HBCommonScript), 2)]
	[ClientScriptResource("MCS.Web.WebControls.WfSimpleActivityDescriptorEditor",
		"MCS.Web.WebControls.Workflow.WfActivityDescriptorEditor.WfSimpleActivityDescriptorEditor.js")]
	[DialogContent("MCS.Web.WebControls.Workflow.WfActivityDescriptorEditor.WfSimpleActivityDescriptorEditor.htm", "MCS.Library.SOA.Web.WebControls")]
	[ToolboxData("<{0}:WfSimpleActivityDescriptorEditor runat=server></{0}:WfSimpleActivityDescriptorEditor>")]
	public class WfSimpleActivityDescriptorEditor : WfActivityDescriptorEditorBase
	{
		...
		{
			userInput.ShowTreeSelector = this.ShowTreeSelector;
