	...
	public class WfAbortControl : WfProcessControlBase
	{
		...
		private bool CanCancelProcess()
		{
			...
			if (CurrentProcess != null)
			{
				...
				result = (CurrentProcess.Status == WfProcessStatus.Running ||
							CurrentProcess.Status == WfProcessStatus.Completed ||
							CurrentProcess.Status == WfProcessStatus.Paused ||
							CurrentProcess.Status == WfProcessStatus.Maintaining)
