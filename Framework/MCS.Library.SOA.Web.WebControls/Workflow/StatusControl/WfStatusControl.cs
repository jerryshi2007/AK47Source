...
namespace MCS.Web.WebControls
{
    ...
    public class WfStatusControl : Control
    {
        ...
        public string ResourceID
        {
            get
            {
                return WebControlUtility.GetViewStateValue(ViewState, "ResourceID", string.Empty);
            }
            set
            {
                WebControlUtility.SetViewStateValue(ViewState, "ResourceID", value);
            }
        }
        ...
        public string ProcessID
        {
            get
            {
                return WebControlUtility.GetViewStateValue(ViewState, "ProcessID", string.Empty);
            }
            set
            {
                WebControlUtility.SetViewStateValue(ViewState, "ProcessID", value);
            }
        }
        ...
        public WfStatusDisplayMode DisplayMode
        {
            get
            {
                return WebControlUtility.GetViewStateValue(ViewState, "DisplayMode", WfStatusDisplayMode.ProcessStatus);
            }
            set
            {
                WebControlUtility.SetViewStateValue(ViewState, "DisplayMode", value);
            }
        }
        ...
        public bool EnableUserPresence
        {
            get
            {
                return WebControlUtility.GetViewStateValue(ViewState, "EnableUserPresence", false);
            }
            set
            {
        ...
        public string DefaultStatusText
        {
            get
            {
                return WebControlUtility.GetViewStateValue(ViewState, "DefaultStatusText", "状态跟踪");
            }
            set
            {
                WebControlUtility.SetViewStateValue(ViewState, "DefaultStatusText", value);
            }
        }
