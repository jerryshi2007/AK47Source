...
[assembly: WebResource("MCS.Web.WebControls.UserControl.UserOUGraphControl.js", "application/x-javascript")]
...
namespace MCS.Web.WebControls
{
    ...
    [ClientScriptResource("MCS.Web.WebControls.UserOUGraphControl", "MCS.Web.WebControls.UserControl.UserOUGraphControl.js")]
    [DialogContent("MCS.Web.WebControls.UserControl.userOUDialogTemplate.htm")]
    [ToolboxData("<{0}:UserOUGraphControl runat=server></{0}:UserOUGraphControl>")]
    public class UserOUGraphControl : DialogControlBase<UserControlParams>
    {
        ...
        public bool EnableUserPresence
        {
            get
            {
                return this.ControlParams.EnableUserPresence;
            }
            set
            {
                this.ControlParams.EnableUserPresence = value;
            }
        }
        ...
        public string RootPath
        {
            get
            {
                return this.ControlParams.RootPath;
            }
            set
            {
                this.ControlParams.RootPath = value;
            }
        }
        ...
        public bool MergeSelectResult
        {
            get
            {
                return ControlParams.MergeSelectResult;
            }
            set
            {
                ControlParams.MergeSelectResult = value;
            }
        }
        ...
        public bool ShowDeletedObjects
        {
            get
            {
                return ControlParams.ShowDeletedObjects;
            }
            set
            {
                ControlParams.ShowDeletedObjects = value;
            }
        }
        ...
        protected override void OnPreRender(EventArgs e)
        {
            if (Page.IsCallback == false)
            {
                ...
                if (this.EnableUserPresence)
                    this.rootContainer.Controls.Add(new UserPresence());
