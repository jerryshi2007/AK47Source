...
namespace MCS.Library.WF.Contracts.PropertyDefine
{
    public static class ClientPropertyExtensions
    {
        ...
        public static Type ToRealType(this ClientPropertyDataType pdt)
        {
            ...
            TryToRealType(pdt, out result).FalseThrow(
                Translator.Translate(Define.DefaultCulture, "不支持PropertyDataType的{0}类型转换为CLR的数据类型", pdt));
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        public static ClientPropertyDataType ToClientPropertyDataType(this System.Type type)
        {
            type.NullCheck("type");
