...
namespace MCS.Library.OGUPermission.Commands
{
	...
	/// 
	/// </summary>
	public class GetUserLeaders : CommandBase
	{
		/// <summary>
		/// 
		/// </summary>
		/// <param name="name"></param>
		public GetUserLeaders(string name)
			: base(name)
		{
		}
		...
		public override void Execute(string argument)
		{
			...
			foreach (IUser user in userList)
				user.SecretaryOf.ToList().ForEach(obj => OutputHelper.OutputObjectInfo(obj));
		}
		...
		public override string HelperString
		{
			get
			{
				return "getUserLeaders {userLogonName}";
			}
		}
	}
}
