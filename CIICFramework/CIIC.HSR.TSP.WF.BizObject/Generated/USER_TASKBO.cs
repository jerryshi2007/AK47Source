...
namespace CIIC.HSR.TSP.WF.BizObject
{
    ...
    [MappedToAttribute("TSPWF_USER_TASK")]
    [BizObjectCode("TSPWF_USER_TASK")]
    public partial class USER_TASKBO : BizObjectBase<USER_TASKBO>
    {
		...
		public USER_TASKBO(BusinessObjectView metadataView):base(metadataView)
		{
