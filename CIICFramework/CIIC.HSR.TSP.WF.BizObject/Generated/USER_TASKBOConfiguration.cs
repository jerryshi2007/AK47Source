...
{
    // TSPWF_USER_TASK
    public partial class USER_TASKBOConfiguration : EntityTypeConfiguration<USER_TASKBO>
    {
        public USER_TASKBOConfiguration(string schema = "dbo")
        {
            ToTable(schema + ".TSPWF_USER_TASK");
